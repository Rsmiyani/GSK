...
--
-- NEXT STEPS:
--   1. Visit http://localhost/GSK/login.php
...
--     → It will regenerate bcrypt hashes for your PHP version
--     → Delete setup.php after running!
--
--   ✗ Flavor not showing in customer pages?
--     → Ensure all PHP files in customer/ were updated
--     → Restart your web server (XAMPP Control Panel)
--
-- FEATURES INCLUDED:
